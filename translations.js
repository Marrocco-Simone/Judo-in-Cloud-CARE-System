...
const TRANSLATIONS = {
  ...
  en: {
    ...
    shortcuts: {
      ...
      wheel: "Mouse wheel / + and -",
      zoom: "Zoom in / out",
      drag: "Drag the video (when zoomed)",
      move: "Move the video",
      r: "R / 0 / double-click",
  ...
  de: {
    ...
    shortcuts: {
      ...
      drag: "Video ziehen (mit Zoom)",
      move: "Video verschieben",
      r: "R / 0 / Doppelklick",
  ...
  es: {
    ...
    shortcuts: {
      ...
      wheel: "Rueda del ratón / + y -",
      zoom: "Acercar / alejar",
      drag: "Arrastrar el vídeo (con zoom)",
      move: "Mover el vídeo",
      r: "R / 0 / doble clic",
  ...
  fr: {
    ...
    shortcuts: {
      ...
      wheel: "Molette de la souris / + et -",
      zoom: "Zoom avant / arrière",
      drag: "Faire glisser la vidéo (avec zoom)",
      move: "Déplacer la vidéo",
      r: "R / 0 / double-clic",
  ...
  pt: {
    ...
    shortcuts: {
      ...
      wheel: "Roda do rato / + e -",
      zoom: "Aproximar / afastar",
      drag: "Arrastar o vídeo (com zoom)",
      move: "Mover o vídeo",
      r: "R / 0 / duplo clique",
