...
const TRANSLATIONS = {
  it: {
    ...
    settings: {
      ...
      live_link: "Link del tatami (Judo in Cloud)",
      live_link_placeholder: "https://judoincloud.com/nome-della-gara/tatami/1",
      live_link_hint: "Incolla il link della pagina pubblica del tatami su judoincloud.com o demo.judoincloud.com",
  ...
  en: {
    ...
    settings: {
      ...
      live_link: "Tatami link (Judo in Cloud)",
      live_link_placeholder: "https://judoincloud.com/competition-name/tatami/1",
      live_link_hint: "Paste the link of the public tatami page on judoincloud.com or demo.judoincloud.com",
      log_db: "Log database operations",
    },
    delete: {
  ...
  de: {
    ...
    settings: {
      ...
      live_link: "Tatami-Link (Judo in Cloud)",
      live_link_placeholder: "https://judoincloud.com/wettkampf-name/tatami/1",
      live_link_hint: "Den Link der öffentlichen Tatami-Seite auf judoincloud.com oder demo.judoincloud.com einfügen",
